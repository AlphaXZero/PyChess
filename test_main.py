...
class TestCheckCheck:
    ...
    def test_check_by_bishop(self):
        ...
        board[0][0] = ("bishop", "white")  # orthographe gardée comme dans ton code
    ...
    def test_en_passant_capture_by_white(self):
        ...
        assert result[3][5] == VOID_CELL  # pion noir capturé
        assert result[3][4] == VOID_CELL
